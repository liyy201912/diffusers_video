...
from ..transformers.transformer_temporal import (
    ...
    TransformerTemporalModel, TransformerSpatioMambaTemporalModel, TransformerMambaTemporalModel
)
...
def get_down_block(
    ...
    elif down_block_type == "CrossAttnDownBlockSpatioMambaTemporal":
        # added for SDV
        if cross_attention_dim is None:
            raise ValueError("cross_attention_dim must be specified for CrossAttnDownBlockSpatioTemporal")
        return CrossAttnDownBlockSpatioMambaTemporal(
            in_channels=in_channels,
            out_channels=out_channels,
            temb_channels=temb_channels,
            num_layers=num_layers,
...
def get_up_block(
    ...
    elif up_block_type == "CrossAttnUpBlockSpatioMambaTemporal":
        # added for SDV
        if cross_attention_dim is None:
            raise ValueError("cross_attention_dim must be specified for CrossAttnUpBlockSpatioTemporal")
        return CrossAttnUpBlockSpatioMambaTemporal(
            in_channels=in_channels,
            out_channels=out_channels,
            prev_output_channel=prev_output_channel,
            temb_channels=temb_channels,
...
def get_mid_block(
    ...
    elif mid_block_type == "UNetMidBlockSpatioMambaTemporal":
        return UNetMidBlockSpatioMambaTemporal(
            in_channels=in_channels,
            temb_channels=temb_channels,
            transformer_layers_per_block=transformer_layers_per_block,
            cross_attention_dim=cross_attention_dim,
...
# class UNetMidBlock3DMambaCrossAttn(nn.Module):
#     def __init__(
#         self,
#         in_channels: int,
#         temb_channels: int,
...
# vae encoder
class MidBlockTemporalEncoder(nn.Module):
    def __init__(
        self,
        in_channels: int,
        out_channels: int,
...
class DownBlockTemporalEncoder(nn.Module):
    def __init__(
        self,
        in_channels: int,
        out_channels: int,
...
class UNetMidBlockSpatioMambaTemporal(nn.Module):
    def __init__(
        self,
        in_channels: int,
        temb_channels: int,
...
class CrossAttnDownBlockSpatioMambaTemporal(nn.Module):
    """Replace transformer temporal to mamba"""
    def __init__(
        self,
        in_channels: int,
        out_channels: int,
        ...
        for i in range(num_layers):
            ...
            attentions.append(
                TransformerSpatioMambaTemporalModel(
                    num_attention_heads,
                    out_channels // num_attention_heads,
                    in_channels=out_channels,
                    num_layers=transformer_layers_per_block[i],
...
class CrossAttnUpBlockSpatioMambaTemporal(nn.Module):
    """Replace temporal transformer to mamba"""
    def __init__(
        self,
        in_channels: int,
        out_channels: int,
