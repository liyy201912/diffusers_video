...
from .lumiere import ConvInflationBlock
...
class TemporalResnetBlock(nn.Module):
    ...
    def forward(self, input_tensor: torch.FloatTensor, temb: torch.FloatTensor) -> torch.FloatTensor:
        ...
        hidden_states = self.norm1(hidden_states)
        hidden_states = hidden_states.reshape(b, c, t, h, w)
...
# Lumiere SpatioTemporalResBlock
class LumiereSpatioTemporalResBlock(nn.Module):
    r"""
    A SpatioTemporal Resnet block.
    ...
    def __init__(
        ...
        **kwargs
        ...
        # (2+1)D resblock for temporal information
        self.temporal_res_block = ConvInflationBlock(
    ...
    def forward(
        ...
        assert image_only_indicator is not None, f"image_only_indicator is {image_only_indicator}"
        ...
        hidden_states += self.temporal_res_block(hidden_states, batch_size=batch_size)
